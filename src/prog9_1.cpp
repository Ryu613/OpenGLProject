...
void init(GLFWwindow* window) {
	renderingProgram = Utils::createShaderProgram("shader/vertShader_p9_1.glsl", "shader/fragShader_p9_1.glsl");
	...
	skyboxTexture = Utils::loadTexture("texture/alien.jpg");
...
void display(GLFWwindow* window, double currentTime) {
	...
	glDrawArrays(GL_TRIANGLES, 0, 36); // 没有深度测试的情况下绘制,绘制完再打开
