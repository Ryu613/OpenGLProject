...
void init(GLFWwindow* window) {
	renderingProgram = Utils::createShaderProgram("shader/vertShader_p9_3.glsl", "shader/fragShader_p9_3.glsl");
	renderingProgramCubeMap = Utils::createShaderProgram("shader/vertShaderCube_p9_3.glsl", "shader/fragShaderCube_p9_3.glsl");
	...
	skyboxTexture = Utils::loadCubeMap("texture/cubemap"); // expects a folder name
...
int main(void) {
	...
	GLFWwindow* window = glfwCreateWindow(800, 800, "Chapter9 - program 3", NULL, NULL);
