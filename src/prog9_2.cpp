...
void init(GLFWwindow* window) {
	renderingProgram = Utils::createShaderProgram("shader/vertShader_p9_2.glsl", "shader/fragShader_p9_2.glsl");
	renderingProgramCubeMap = Utils::createShaderProgram("shader/vertShaderCube_p9_2.glsl", "shader/fragShaderCube_p9_2.glsl");
