...
void init(GLFWwindow* window) {
    renderingProgram1 = Utils::createShaderProgram("shader/vertShader1_p8_1.glsl", "shader/fragShader1_p8_1.glsl");
    renderingProgram2 = Utils::createShaderProgram("shader/vertShader2_p8_1.glsl", "shader/fragShader2_p8_1.glsl");
...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(800, 800, "Chapter8 - program 1", NULL, NULL);
