...
void init(GLFWwindow* window) {
    renderingProgram = Utils::createShaderProgram("shader/vertShader_p7_2.glsl", "shader/fragShader_p7_2.glsl");
    // 构建透视矩阵
    // 获取glfw窗口的宽高
...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(800, 800, "Chapter7 - program 2", NULL, NULL);
